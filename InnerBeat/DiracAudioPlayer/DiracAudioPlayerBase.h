...
@interface DiracAudioPlayerBase : NSObject
{
	...
	/*volatile*/ SInt64 mLastResetPositionInFile;
	/*volatile*/ SInt64 mFramePositionInInputFile;
...
@property (readwrite) /*volatile*/ SInt64 mFramePositionInInputFile;
@property (readwrite) /*volatile*/ SInt64 mLastResetPositionInFile;
